...
public class Fame {
	...
	public List<Formula> FameCR(Set<AtomicRole> r_sig, List<Formula> formula_list) throws OWLOntologyCreationException, CloneNotSupportedException {
		return FameCR(new HashSet<>(), r_sig, formula_list);
	}
